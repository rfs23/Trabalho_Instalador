...
public class ComparacaoTruco implements ComparaCartas {
    ...
    /**
     * Seguindo as regras do truco, compara duas cartas, e informa qual é a
     * maior.
     *
     * @param carta1 - Carta 1 da comparação.
     * @param carta2 - Carta 2 da comparação.
     * @return 1 - se a carta 1 tiver peso maior -1 - se a carta 2 tiver peso
     * maior 0 - se as cartas forem consideradas iguais.
     */
    @Override
    public int eMaior(Carta carta1, Carta carta2) {

        int pesoCarta1 = pesoTruco(carta1);
        int pesoCarta2 = pesoTruco(carta2);

        if (carta1.getValor() == carta2.getValor() && carta1.getValor() != valorMando) {
    ...
    /**
     * Atribui peso maior para cartas que são consideradas mais "fortes" no
     * truco. São elas: A, 2, 3. Ou então a "carta vira" que determina qual
     * carta será a "mais forte" do jogo. Sempre é a carta de valor seguinte ao
     * da " carta vira".
     *
     * @param carta - Carta a qual será atribuído o peso.
     * @return - peso da carta (getPesoCarta()) multiplicado pelos valores
     * seguintes do baralho. Por exemplo: A (1) * 14, 2 * 15...
     */
     ...
     */
    public final void setCartaVira(Carta cartaVira) {
